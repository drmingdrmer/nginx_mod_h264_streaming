...
MOD_STREAMING_DLL_LOCAL extern char const* mime_type_flv;
MOD_STREAMING_DLL_LOCAL extern char const* mime_type_ismc;
MOD_STREAMING_DLL_LOCAL extern char const* mime_type_mp4;
MOD_STREAMING_DLL_LOCAL extern char const* mime_type_ts;
...
MOD_STREAMING_DLL_LOCAL extern
mp4_context_t* mp4_context_init(const char* filename, int verbose);
MOD_STREAMING_DLL_LOCAL extern
void mp4_context_exit(mp4_context_t* mp4_context);
